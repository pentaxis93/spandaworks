...
from spanda_telemetry.embeddings.model import get_embedding
...
def reflect(
    ...
    try:
        ...
        emit_event(
            ...
            {
                "spanda.session.id": session_id or "unknown",
                "spanda.reflection.id": reflection_id,
                "spanda.reflection.trigger": trigger or "manual",
                "spanda.reflection.type": _classify_reflection(content),
            },
