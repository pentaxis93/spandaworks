...
from spandaworks_telemetry.embeddings.model import get_embedding
...
def reflect(
    ...
    try:
        ...
        emit_event(
            ...
            {
                "spandaworks.session.id": session_id or "unknown",
                "spandaworks.reflection.id": reflection_id,
                "spandaworks.reflection.trigger": trigger or "manual",
                "spandaworks.reflection.type": _classify_reflection(content),
            },
