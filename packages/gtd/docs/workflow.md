# GTD Workflow with spanda-gtd

A practical guide to implementing Getting Things Done with spanda-gtd.
...
spanda-gtd implements this with TaskWarrior as the backend and MCP tools for AI assistance.
