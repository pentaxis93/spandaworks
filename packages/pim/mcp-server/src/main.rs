//! spanda-pim: MCP server for Personal Information Management
//!
...
async fn main() -> Result<()> {
    ...
    tracing_subscriber::registry()
        ...
        .with(EnvFilter::from_default_env().add_directive("spanda_pim=info".parse()?))
        .init();

    tracing::info!("Starting spanda-pim MCP server");
