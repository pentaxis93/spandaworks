...
Librarians are high-level agentic workers that maintain the Talos system. They are universal roles with domain-specific instructions.
...
This creates a unified reflection surface across all Talos packages.
